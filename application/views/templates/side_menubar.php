            ...
            <li class="treeview" id="mainCustomerNav">
              ...
              <ul class="treeview-menu">
                <?php if(in_array('createCustomer', $user_permission)): ?>
                  <li id="addCustomerNav"><a href="<?php echo base_url('customers/create') ?>"><i class="fa fa-circle-o"></i> Add Customer</a></li>
                <?php endif; ?>
