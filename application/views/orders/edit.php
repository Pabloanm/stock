              ...
              <div class="box-body">
                         ...
                         <td>
                          <select class="form-control select_group product" data-row-id="row_<?php echo $x; ?>" id="product_<?php echo $x; ?>" name="product[]" style="width:100%;" onchange="getProductData(<?php echo $x; ?>)" required>
                              ...
                              <?php foreach ($products as $k => $v): ?>
                                <option value="<?php echo $v['id'] ?>" <?php if($val['product_id'] == $v['id']) { echo "selected='selected'"; } ?>><?php echo $v['sku'] ?> - <?php echo $v['brandname'] ?> -  <?php echo $v['name'] ?></option>
                              <?php endforeach ?>
                            </select>
                          </td>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <!-- arreglar este select, falta Paid Status -->
                   ...
                   '<td>'+ 
                    '<select class="form-control select_group product" data-row-id="'+row_id+'" id="product_'+row_id+'" name="product[]" style="width:100%;" onchange="getProductData('+row_id+')">'+
                        ...
                        $.each(response, function(index, value) {
                          html += '<option value="'+value.id+'">'+value.sku+' - '+value.brandname+' - '+value.name+'</option>';               
                        });
